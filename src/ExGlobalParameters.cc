...
//New input files
double CGlobalParameters::pixenergy = 1;
double CGlobalParameters::bineclouds = 1;
double CGlobalParameters::txteclouds = 1;
double CGlobalParameters::stepview = 1;
double CGlobalParameters::pixnumber = 20;
